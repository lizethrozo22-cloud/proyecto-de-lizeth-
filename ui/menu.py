        ...
        try:
            while True:
                ...
                if option == "0":
                    ...
                    print("x Opción inválida. Intenta de nuevo.")
...
def show_general_statistics(self):
    ...
    print(f"Estudiantes: {student_stats.get('total', 0)}")
    print(f"Profesores: {teacher_stats.get('total', 0)}")
